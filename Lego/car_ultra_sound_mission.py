...
def main():
    ...
    move(400) # distance forward

    arm_up()
    
    wait(200)

    move(-270) # backwards movement after dropping car

    turn(90)

    turn (90) 

    move(50) # then car should be infront of rooot, to check use ultra sonic sensor
    ...
    while True:
        ...
        if distance <= SAFE_DISTANCE:
            ...
            arm_down() # Capture car

            turn(20)

            move(300) # back to base
